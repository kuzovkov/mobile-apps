...
class MessageList extends StatelessWidget {
  ...
  Widget _buildItem(document){
    var msg;
    if (document['type'] == 0)
      msg = Text(document['content'] ?? '<No message retrieved>');
    ...
    return Container(
      child: Row(
        children: <Widget>[
          _buildMessageAvatar(document['idFrom']),
...
class ChatPage2 extends StatefulWidget {
  ChatPage2({Key key, @required this.responseUser}) : super(key: key);
  final User responseUser;
  @override
  ChatPage2State createState() => ChatPage2State();
}


class ChatPage2State extends State<ChatPage2> {
  ...
  Future<void> _addMessage() async {
    ...
    await messages.add(<String, dynamic>{
      'content': 'Hello ${widget.responseUser.nickname}!',
